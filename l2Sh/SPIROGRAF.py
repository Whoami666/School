...
root = Tk()
lab1 = Label(root, text = "Ââåäèòå R", font = "Ubuntu, 20", bg = "purple", fg = "yellow", width = 10)
lab2 = Label(root, text = "Ââåäèòå r", font = "Ubuntu, 20", bg = "purple", fg = "yellow", width = 10)
lab3 = Label(root, text = "Ââåäèòå d", font = "Ubuntu, 20", bg = "purple", fg = "yellow", width = 10)
